...
const somSom = new Audio("src/audio/som.mp3");
const somperdeu = new Audio("src/audio/perdeu.mp3");
const somcoin = new Audio("src/audio/coin.mp3");
const somparabens = new Audio("src/audio/parabens.mp3");
...
function novaPergunta() {
  ...
  const opcoes = [...paisesCorretos.slice(0, 1), ...paisesErrados.slice(0, 7)];
  shuffleArray(opcoes);
  ...
  opcoes.forEach((pais) => {
    ...
    img.src = `src/image/${pais.bandeira}`;
    img.alt = pais.nome;
